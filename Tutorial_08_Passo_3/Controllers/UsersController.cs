...
namespace Tutorial_08_Passo_3.Controllers
{
    public class UsersController : Controller
    {
        private readonly Tutorial_08_Passo_3Context_Database _context;

        public UsersController(Tutorial_08_Passo_3Context_Database context)
        {
            _context = context;
        }
        ...
        {
            HttpContext.Response.Cookies.Delete(".Tutorial_08_Passo_3.Session");
