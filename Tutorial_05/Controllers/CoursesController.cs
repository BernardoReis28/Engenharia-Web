...
namespace Tutorial_05.Controllers
{
    public class CoursesController : Controller
    {
        private readonly Tutorial_05Context _context;

        public CoursesController(Tutorial_05Context context)
        {
            _context = context;
        }
        ...
        {
            var tutorial_05Context = _context.Course.Include(c => c.Category);
            return View(await tutorial_05Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Tutorial_05Context.Course'  is null.");
            }
            var course = await _context.Course.FindAsync(id);
            if (course != null)
            {
